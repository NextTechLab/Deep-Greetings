...
output_dir="/Users/aparna/documents/greetings/output"
...
optimizer = tf.train.AdamOptimizer(10,0.9,0.999,1e-8).minimize(total_loss)
#optimiser=tf.train.AdamOptimizer(10,09,0.999,1e-8).minimize(total_loss)
